...
)
{
    ...
    (void)UART_Open(UART_CH2, GIC_PRIORITY_NO_MEAN, 115200UL, UART_POLLING_MODE, UART_CTSRTS_OFF,
                    24U, WORD_LEN_8, ENABLE_FIFO, TWO_STOP_BIT_OFF, PARITY_SPACE, NULL_PTR);                
